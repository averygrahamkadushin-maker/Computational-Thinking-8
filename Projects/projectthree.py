...
# creates for rectangles  

draw_rectangle("orange", 100, 100, 200, 200)
draw_rectangle("yellow", -100, 100, 200, 200)
draw_rectangle("yellow", 100, -100, 200, 200)
draw_rectangle("orange", -100,-100,200,200)
# creates 4 fifferent sprites

s1 = create_sprite("lebron", 100, 100)
s2 = create_sprite("basketball", -100, -150)
s3 = create_sprite("football", 100,-150 ) 
s4 = create_sprite("lakers", -100, 150) 

message1 = create_sprite("alien",-200,200)
message1.color("red")

message1.write("avery",font = ("Arial", 40, "normal"))
# writes avery 

message1.hideturtle()
message1.goto(-250, -250)
message1.write("age 13",font = ("Arial", 40, "normal")) 
